...
Opening a pull request will trigger a[workflow](../.github/workflows/centrica_mlops_demo-run-tests.yml) 
...
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/centrica_mlops_demo/centrica_mlops_demo-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/centrica_mlops_demo/centrica_mlops_demo-model)
. 
